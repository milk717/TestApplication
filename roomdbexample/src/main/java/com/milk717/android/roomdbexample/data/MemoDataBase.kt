package com.milk717.android.roomdbexample.data

import android.content.Context
import androidx.room.Database
import androidx.room.Room
import androidx.room.RoomDatabase
import com.milk717.android.roomdbexample.data.dao.MemoDao
...
abstract class MemoDataBase: RoomDatabase() {
    ...
    //각 RoomDatabase 인스턴스는 리소스를 많이 소피하기 때문에 싱글톤으로 구현하는 것이 좋음
    companion object{
